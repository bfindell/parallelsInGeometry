...
\fixnote{Citation removed until it works.}
%\marginnote{The approach taken in this section was adapted from \cite{krause}.}
...
\fixnote{Do we want this definition?  Or do we want students to develop it?  Check the corresponding activity.}
