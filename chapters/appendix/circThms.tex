...
\begin{prob}
Not all inscribed angles look like those in the previous picture.  Explain how any inscribed angle fits one of the following three cases.  
...
\begin{prob}
How do you need to modify the previous proof(s) to be sure that you have handled all three cases?  
\end{prob}

\begin{teachingnote}
For the third figure, two things are hard:  adding the diameter (or other chord) and then seeing the overlapping angles.
\end{teachingnote}
