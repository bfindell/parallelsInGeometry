...
\fixnote{Precede this with 1.3.7, 8.  The point is connecting the thinking with the geometry with the algebra.  Why does the first one look like an average?  Students might not see the similar triangles in the last one.}
