...
\fixnote{Highlight the definitions.}
\fixnote{Condense, making clear that the key points are the generalizations.  Don't worry about the details.}
...
\fixnote{Get the spacing right below.}
\begin{equation}
x(t) = 2t + 3  \\  y(t) = -t-4
\end{equation}
\begin{enumerate}
