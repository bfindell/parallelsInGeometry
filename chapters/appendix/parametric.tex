...
\fixnote{Need a motivating example.  Sweater sales and snow shovel sales might be correlated, but not because one causes the other.  Teaching note should target, What is a function of what?  Adding vectors.  Can we connect the dots?  Intuitive continuity arguments.  And students should see problems 1 and 4 as the same.}
