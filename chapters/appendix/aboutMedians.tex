...
\fixnote{Supply notes:  Cardstock, thread, 12-inch rulers.}
\begin{prob}  
...
\fixnote{Need the midsgement theorem to do next problem.  Do midsegment either earlier in the course or separately here.}
\begin{prob}
