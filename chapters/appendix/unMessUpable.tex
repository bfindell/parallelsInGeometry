...
\fixnote{Replace the first two problems with levels Tutorial through 9 in Euclid the Game.  Note:  Most bugs in Euclid the Game are fixed by refreshing the page.  Maybe have them start Euclid the Game at home.  Note that the last two problems are optional.}  
