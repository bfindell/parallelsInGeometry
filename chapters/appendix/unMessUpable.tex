...
\fixnote{Replace the first two problems and problems 5 and 6 with levels Tutorial through 12 in Euclid the Game.  Note:  Most bugs in Euclid the Game are fixed by refreshing the page.  Maybe have them start Euclid the Game at home.  Note that the last two problems are optional.}  
