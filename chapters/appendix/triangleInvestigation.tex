...
\fixnote{Do the first three of these at home.  Add a problem that connects this to triangle congruence.  Make clear the point that (often) three congruences are enought to get six.  Add teaching notes to help.  Add a reminder that, e.g., $B$ is vertex of $\angle ABC$.}
\begin{prob}
