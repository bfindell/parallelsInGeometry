...
\fixnote{Beginning here, these are more like constructions and less like measurements.  Revise the instructions so that these ideas can 
be seen with sticks,  rulers, compass, tracing paper, Geogebra.} 
\item $BC = 7$, $CA = 8$, $AB = 9$
\item $BC = 4$, $CA = 8$, $AB = 3$
