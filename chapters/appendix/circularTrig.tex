...
\fixnote{Need A.27, right triangle trig, as preactivity.  Recommend a special office hour for this.  Need to remind students of sine, cosine, and tangent in terms of $x$, $y$, and $r$ in the first quadrant.  Need something about picking $x$ and $y$ for a particular angle.  Need teaching note about extending the domain of an idea.  Some things no longer work the same way.}
