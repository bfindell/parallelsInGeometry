...
\fixnote{Need a picture, using rays for the sides of the angles} 
...
\fixnote{Need a picture with a point and a reference triangle}
...
\begin{prob}
Draw spicture to demonstrate the following: 
\begin{enumerate}
\item $\sin 150^\circ =$
\item $\cos 150^\circ =$
\item $\tan 150^\circ =$
