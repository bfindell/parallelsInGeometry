...
\fixnote{Add teaching note about materials:  tape, scissors, and copies of the net. }
...
\begin{prob}
In this problem you derive the formula for the volume of a sphere of radius $r$.\standard{8.G.9}\standardhs{G-GMD.1}\standardhs{G-GMD.2}   The figures below shows a half-sphere of radius $r$ alongside a cylinder of radius $r$ and height $r$ with a cone of radius $r$ and height $r$ removed.
$$\includegraphics[scale=1.05]{../graphics/sphereVolume}$$
...
\end{enumerate}
\fixnote{Replace graphic?  Include questions about why the blue $h$ values are the same.  Also fix CCSS links.}
\end{prob}
