...
\fixnote{Need a better statement of Cavalieri's Principle.  Slices of the same area at each height.}
...
\fixnote{Actually cut this out of card stock.}
...
\fixnote{Do the following in groups of three.}
...
\fixnote{Need the following thinking:  $r$ is fixed, $h$ and $s$ vary, different cross sections.  Put $s$ in the text.  Height of cylinder and of cone.}
