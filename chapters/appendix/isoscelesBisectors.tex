...
\fixnote{Precede this with the home-activity (A.52) about drawing carefully altitude, median, perpendicular bisector, angle bisector.  Note that they are four different lines.  Then use this activity to prove in an isosceles triangle, the lines coincide.}
...
\fixnote{Now prove that in an isosceles triangle, the four lines are the same line.}
