...
\fixnote{Move some of these to problems or exam review.  Make the remaining more ``activity'' like.  Include cutting.}
\fixnote{Need teaching notes for the first problem.  This is very difficult because they have to draw pictures that are clearly wrong.}
\begin{prob}
...
\fixnote{The following three are essentially one problem.  Or the last one is a reframing of the first one.}
\begin{prob}
