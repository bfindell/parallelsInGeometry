...
\fixnote{materials:  tracing paper}
...
\fixnote{Clean up the following problems, including the hint for HL, which might no longer be necessary.  We might want to add that in an isosceles triangle, the four lines coincide.}
...
% (Hint:  First extend side $\overrightarrow{AC}$ to a point $A'$ so that $CA'=XZ$, and argue that $\triangle A'BC \cong \triangle XYZ$.)  
