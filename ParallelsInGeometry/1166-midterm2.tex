...
\section{Midterm 2 Review (final version)}

Midterm 2 will cover Chapter 4, Sections 5.1 and 5.2, Activities A.21--A.36, and the beginning of A.39. Here are some specific reminders:  
\begin{itemize}\itemsep-3pt
\item Know the distinction between synthetic and analytic geometry.
\item Know the basic rigid motions, what is required to specify them, and their definitions. 
...
\item In coordinate geometry, what is a point?
\item In coordinate geometry, what is a line? 
\item Know how to find an equation of the line containing two given points.  
\item Know how to derive the distance formula quickly. 
\item Know how to derive the midpoint formula quickly.  
\end{itemize}
